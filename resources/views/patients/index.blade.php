<x-app-layout>
    <x-slot name="header">
        <div class="flex justify-between items-center mb-4">
            ...
            <a href="{{ route('patients.create') }}" class="inline-flex items-center px-4 py-2 bg-green-500 hover:bg-green-600 text-white rounded-lg">
                    ...
                    <table class="min-w-full divide-y divide-gray-200">
                        <thead>
                            <tr class="bg-gray-100">
                                ...
                                <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Risk Group</th>
                        ...
                        <tbody class="divide-y divide-gray-200">
                            @foreach ($patients as $patient)
                                <tr>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">{{ $patient->group }}</td>
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <a href="{{ route('patients.edit', $patient->id) }}" class="text-indigo-600 hover:text-indigo-900 mr-2">Edit</a>
