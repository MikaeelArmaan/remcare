<x-app-layout>
    <x-slot name="header">
        <div class="flex justify-between items-center mb-4">
            ...
            <a href="{{ route('doctors.create') }}" class="inline-flex items-center px-4 py-2 bg-green-500 hover:bg-green-600 text-white rounded-lg">
                        ...
                        <tbody class="divide-y divide-gray-200">
                            @foreach ($doctors as $doctor)
                                <tr>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">{{ $doctor->experience }}</td>
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <a href="{{ route('doctors.edit', $doctor->id) }}" class="text-indigo-600 hover:text-indigo-900 mr-2">Edit</a>
